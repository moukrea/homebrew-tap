class SshxMobileHost < Formula
  ...
  version "1.0.5"
  license "MIT"
  url "https://github.com/moukrea/sshx-mobile/releases/download/1.0.5/sshx-mobile-host-1.0.5.tar.gz"
  sha256 "f28fbe3b051fdd488ae271a0bd356bd69dc73c07ba90888dd90384211508376d"
