class SshxMobileHost < Formula
  ...
  version "1.0.1"
  license "MIT"
  url "https://github.com/moukrea/sshx-mobile/releases/download/1.0.1/sshx-mobile-host-1.0.1.tar.gz"
  sha256 "0d916b42bb051831346d45511166a26473228b3164883cf3cd691b0df9bedc54"
